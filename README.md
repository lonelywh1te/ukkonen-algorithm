...
- Внутренняя вершина — любая вершина дерева, имеющий потомков, и таким образом, не являющийся листом.
...
![Дерево для строки "abc"](/images/img4_0.jpg)
...
![Дерево для строки "abca"](/images/img4_1.jpg)  

Добавляем следующий символ **x**. Переменная # = 6.  
На фото выше видно, что мы не можем спуститься дальше по ребру, так как символа **х** нет.
Поэтому мы делим ребро и подвешиваем новую вершину. Теперь наше дерево имеет вид:

![Дерево для строки "abcab"](/images/img4_2.jpg)  
